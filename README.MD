...
8. [Integración entre Tecnologías](#-integración-entre-tecnologías)
...
- 💾 **Bases de datos independientes** - PostgreSQL para cada servicio
...
### Backend TypeScript (Puerto 3000)
...
- **pgAdmin** o **DBeaver** - Cliente de PostgreSQL
